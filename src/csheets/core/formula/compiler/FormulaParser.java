// $ANTLR 3.5.2 ../src/csheets/core/formula/compiler/Formula.g 2014-06-06 10:46:30
...
public class FormulaParser extends Parser {
	...
	// ../src/csheets/core/formula/compiler/Formula.g:49:1: attribution : CELL_REF ATT ^ ( comparison | attribution ) ;
	public final FormulaParser.attribution_return attribution() throws RecognitionException {
		...
		ParserRuleReturnScope attribution8 =null;

		Object CELL_REF5_tree=null;
		Object ATT6_tree=null;

		try {
			// ../src/csheets/core/formula/compiler/Formula.g:50:9: ( CELL_REF ATT ^ ( comparison | attribution ) )
			// ../src/csheets/core/formula/compiler/Formula.g:50:11: CELL_REF ATT ^ ( comparison | attribution )
			{
			root_0 = (Object)adaptor.nil();
			...
			// ../src/csheets/core/formula/compiler/Formula.g:50:25: ( comparison | attribution )
			int alt2=2;
			int LA2_0 = input.LA(1);
			if ( (LA2_0==FUNCTION||LA2_0==LPAR||LA2_0==MINUS||LA2_0==NUMBER||LA2_0==STRING) ) {
				alt2=1;
			}
			else if ( (LA2_0==CELL_REF) ) {
				int LA2_2 = input.LA(2);
				if ( (LA2_2==ATT) ) {
					alt2=2;
				}
				else if ( (LA2_2==EOF||LA2_2==AMP||LA2_2==COLON||(LA2_2 >= DIV && LA2_2 <= EQ)||(LA2_2 >= GT && LA2_2 <= GTEQ)||(LA2_2 >= LT && LA2_2 <= NEQ)||(LA2_2 >= PERCENT && LA2_2 <= POWER)) ) {
					alt2=1;
				}
			...
			switch (alt2) {
				case 1 :
					// ../src/csheets/core/formula/compiler/Formula.g:50:26: comparison
					{
					pushFollow(FOLLOW_comparison_in_attribution123);
					...
					break;
				case 2 :
					// ../src/csheets/core/formula/compiler/Formula.g:50:39: attribution
					{
					pushFollow(FOLLOW_attribution_in_attribution127);
					attribution8=attribution();
					state._fsp--;

					adaptor.addChild(root_0, attribution8.getTree());
	...
	public static final BitSet FOLLOW_comparison_in_attribution123 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_attribution_in_attribution127 = new BitSet(new long[]{0x0000000000000002L});
