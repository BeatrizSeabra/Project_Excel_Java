 ...
 */
public class TEMP implements Reference{
	 ...
	 */
	public TEMP(Cell cell, boolean columnAbsolute, boolean rowAbsolute) {
		this.cell = cell;
	 ...
	 */
	public TEMP(Spreadsheet spreadsheet, String reference) throws ParseException {
