...
public class TxtAction extends BaseAction {
    ...
    /**
     * Class that implements Runnable to run the Thread. This thread is used to run the program in parallel to the thread.
     */
    ...
    /**
     * Method to write the file. This method it's called only when the export button is pressed.
     * After this method occurs, it occurs again only when the button is pressed again. Otherwise, the method that will be called is the ExportFileWithParameters that contains the file path, separator and header.
     * @param file 
     */
     ...
     * means that the export action already was called once and already is
     * created a file with content. So the class verifies if there any changed
     * cell and calls this method to write on the file.
     *
     * @param file
     */
    ...
    /**
     * Implements cell listeners on the active spreedsheet. This class
     * implements cell listeners to all of the cell on the active spreedsheet,
     * so if any cell change, it will set boolean true and write on the file
     */
