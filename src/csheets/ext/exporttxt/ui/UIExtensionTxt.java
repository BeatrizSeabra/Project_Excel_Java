 ...
 * @author Tiba
 */
public class UIExtensionTxt extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private TxtMenu menu;

	public UIExtensionTxt(Extension extension, UIController uiController) {
