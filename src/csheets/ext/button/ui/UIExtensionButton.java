...
/**
 * This class implements the UI interface extension for the button extension. A
 * UI interface extension must extend the UIExtension abstract class.
 *
 * @author Tiba
 */
public class UIExtensionButton extends UIExtension {
    ...
    public UIExtensionButton(Extension extension, UIController uiController) {
    ...
    public JMenu getMenu() {
        if (menu == null) {
            menu = new ButtonMenu(uiController);
        }
        return menu;
    }
