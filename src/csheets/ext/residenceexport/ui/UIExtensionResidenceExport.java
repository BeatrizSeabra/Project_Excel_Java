 ...
 */
public class UIExtensionResidenceExport extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private ResidenceExportMenu menu;

	public UIExtensionResidenceExport(Extension extension, UIController uiController) {
	 ...
	 * @see ResidenceExportMenu
	 * @return a JMenu component
	 */
	public JMenu getMenu() {
		if (menu == null)
                    menu = new ResidenceExportMenu(uiController);
		return menu;
	}
