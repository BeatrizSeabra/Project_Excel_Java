 ...
 */
public class UIExtensionResidenceImport extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private ResidenceImportMenu menu;

	public UIExtensionResidenceImport(Extension extension, UIController uiController) {
	...
	public JMenu getMenu() {
		if (menu == null)
			menu = new ResidenceImportMenu(uiController);
		return menu;
	}
