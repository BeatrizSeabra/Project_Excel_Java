 ...
 */
public class UINetworkGame extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private NetworkGameMenu menu;

	public UINetworkGame(Extension extension, UIController uiController) {
	...
	public JMenu getMenu() {
		if (menu == null)
			menu = new NetworkGameMenu(uiController);
		return menu;
	}
