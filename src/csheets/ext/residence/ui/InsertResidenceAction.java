 ...
 */
public class InsertResidenceAction extends BaseAction {
	 ...
	 */
	public InsertResidenceAction(UIController uiController) {
		this.uiController = uiController;
	}

	protected String getName() {
		return "Insert Residence...";
	}
	...
	public void actionPerformed(ActionEvent event) {
            InsertResidenceUI residenceUI = new InsertResidenceUI();
