 ...
 */
public class UIExtensionFindWorkbooksFiles extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private FindWorkbooksFilesMenu menu;

	public UIExtensionFindWorkbooksFiles(Extension extension, UIController uiController) {
	 ...
	 * @see FindWorkbooksFilesMenu
	 * @return a JMenu component
	 */
	public JMenu getMenu() {
		if (menu == null)
			menu = new FindWorkbooksFilesMenu(uiController);
		return menu;
	}
