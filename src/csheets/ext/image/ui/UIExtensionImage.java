 ...
 * @author Nélson
 */
public class UIExtensionImage extends UIExtension{

    private Icon icon;

	/** The menu of the extension */
    private ImageMenu menu;

	public UIExtensionImage(Extension extension, UIController uiController) {
	...
	public JMenu getMenu() {
		if (menu == null)
			menu = new ImageMenu(uiController);
		return menu;
	}
