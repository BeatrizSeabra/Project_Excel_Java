 ...
 */
public class UIExtensionLogFile extends UIExtension {

	/** The icon to display with the extension's name */
	private Icon icon;

	/** The menu of the extension */
	private LogFileMenu menu;

	public UIExtensionLogFile(Extension extension, UIController uiController) {
	...
	public JMenu getMenu() {
		if (menu == null)
			menu = new LogFileMenu(uiController);
		return menu;
	}
